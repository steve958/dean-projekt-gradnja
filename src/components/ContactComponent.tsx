    ...
    return (
        <div className="container">
            ...
            <div className="contact_icons_container">
                <span className="contact_icon_wrapper" title="Donja Pastuša 23, Petrinja, HR">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50"
                ...
                <span className="contact_icon_wrapper" title="info@deanprojektgradnja.com">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50"
                ...
                <span className="contact_icon_wrapper" title="+385 95 3466323">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="40"
